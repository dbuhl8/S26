...
#set key bottom left
unset key
set ylabel "w_{rms}/u_{h,rms}" rotate by 0 
#set title "w_{rms, eff} reconstruction"
set log xy
...
#"" i 2 u (($2**0.5)/$8):($12/$8) w yerrorbars pt 4 ps 2 lc rgb "red" title 'Steady (Re,Pr) = (1000,0.1)',\
#"" i 3 u (($2**0.5)/$8):($12/$8) w yerrorbars pt 4 ps 2 lc rgb "dark-violet" title 'Steady (Re,Pr) = (300,0.1)',\
#"" i 4 u (($2**0.5)/$8):($12/$8) w yerrorbars pt 4 ps 2 lc rgb "forest-green" title 'Steady (Re,Pr) = (1000,0.01)',\
#"" i 1 u (($2**0.5)/$8):($12/$8) w yerrorbars pt 7 ps 2 lc rgb "red" title 'Stoch (Re,Pr) = (1000,0.1)',\
#[1:10] 0.4*x**(-1) dt 2 lw 2 lc rgb "forest-green" title '0.4 Fr_{eff}^{-1}'
