...
def main():
    ...
    ax.set_xscale('log')
    ax.set_ylim(-0.05, 1)
    ax.set_xlabel(r'$Re_B^*$', fontsize=28)
    ax.set_ylabel(r'$V_\mathrm{Turb}$', fontsize=28)
    ax.legend(loc='upper left', fontsize=16)
    ax.tick_params(labelsize=22)

    plt.tight_layout()
    plt.savefig('Reb_VTurb_colorblind.pdf')
    plt.savefig('Reb_VTurb_colorblind.png', dpi=150)
    print("Saved Reb_VTurb_colorblind.pdf and Reb_VTurb_colorblind.png")
